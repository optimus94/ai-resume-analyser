...
const Navbar = () => {
  ...
  return /* @__PURE__ */ jsxs("nav", { className: "navbar", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-row gap-2", children: [
      ...
      /* @__PURE__ */ jsx("button", { className: "secondary-button w-fit", onClick: auth2.signOut, children: "Log Out" })
    ] })
  ] });
};
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "resume-card-header", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2", children: [
            companyName && /* @__PURE__ */ jsxs("h2", { className: "!text-back font-bold break-words", children: [
              " ",
              companyName,
              " "
            ] }),
            jobTitle && /* @__PURE__ */ jsxs("h3", { className: "text-lg break-words text-gray-500", children: [
              " ",
              jobTitle,
              " "
            ] }),
            !companyName && !jobTitle && /* @__PURE__ */ jsx("h2", { className: "!text-back font-bold", children: " Resume " })
          ] }),
...
const FileUploader = ({ onFileSelect }) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "w-full gradient-border", children: /* @__PURE__ */ jsxs("div", { ...getRootProps(), children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "space-y-4 cursor-pointer", children: file ? /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "flex items-center space-x-3", children: /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-700 font-medium truncate max-w-xs", children: file.name }),
      ...
      /* @__PURE__ */ jsx("div", { className: "mx-auto w-16 h-16 flex item-center justify-center mb-4", children: /* @__PURE__ */ jsx("img", { src: "/icons/info.svg", alt: "Upload", className: "size-20" }) }),
...
async function convertPdfToImage(file) {
  try {
    ...
    if (viewport.width > 8e3 || viewport.height > 8e3) {
      return {
        imageUrl: "",
        file: null,
...
const Ats = ({ score, suggestions }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: `bg-gradient-to-b ${gradientClass} to-white rounded-2xl shadow-md w-full p-6`, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mb-6", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "space-y-3", children: suggestions.map((suggestions2, index) => /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
        /* @__PURE__ */ jsx(
          "img",
          {
            src: suggestions2.type === "good" ? "/icons/check.svg" : "/icons/warning.svg",
            alt: suggestions2.type === "good" ? "Check" : "Warning",
            className: "w-5 h-5 mt-1"
          }
        ),
        /* @__PURE__ */ jsx("p", { className: suggestions2.type === "good" ? "text-green-700" : "text-amber-700", children: suggestions2.tip })
      ] }, index)) })
    ] }),
...
const ScoreBadge = ({ score }) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: `px-3 py-1 rounded-full ${badgeColor}`, children: /* @__PURE__ */ jsx("p", { className: "text-sm font-medium", children: badgeLabel }) });
};
...
const Resume = () => {
  ...
  const navigate = useNavigate();
  useEffect(() => {
    if (!isLoading && !auth2.isAuthenticated) navigate(`/auth?next=/reusme/${id}`);
  }, [isLoading]);
  useEffect(() => {
    const loadResume = async () => {
...
const WipeApp = () => {
  ...
  const handleDeleteAll = async () => {
    const confirmed = window.confirm("Are you sure you want to delete ALL files? This action cannot be undone.");
    if (!confirmed) return;
  ...
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [/* @__PURE__ */ jsxs("div", {
      className: "mb-4",
      children: ["Authenticated as: ", auth2.user?.username]
    }), /* @__PURE__ */ jsx("div", {
...
const serverManifest = { "entry": { "module": "/ai-resume-analyser/assets/entry.client-D-QymF_R.js", "imports": ["/ai-resume-analyser/assets/chunk-4WY6JWTD-Dcf9bGPO.js"], "css": [] }, "routes": { "root": { "id": "root", "parentId": void 0, "path": "", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": true, "module": "/ai-resume-analyser/assets/root-C7hdxCHd.js", "imports": ["/ai-resume-analyser/assets/chunk-4WY6JWTD-Dcf9bGPO.js", "/ai-resume-analyser/assets/puter-CplJNx_h.js"], "css": ["/ai-resume-analyser/assets/root-Bftr_8xH.css"], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/home": { "id": "routes/home", "parentId": "root", "path": void 0, "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": false, "module": "/ai-resume-analyser/assets/home-CF71oAFC.js", "imports": ["/ai-resume-analyser/assets/chunk-4WY6JWTD-Dcf9bGPO.js", "/ai-resume-analyser/assets/Navbar-BQbs2jcz.js", "/ai-resume-analyser/assets/puter-CplJNx_h.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/auth": { "id": "routes/auth", "parentId": "root", "path": "/auth", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": false, "module": "/ai-resume-analyser/assets/auth-DsjXCdDa.js", "imports": ["/ai-resume-analyser/assets/chunk-4WY6JWTD-Dcf9bGPO.js", "/ai-resume-analyser/assets/puter-CplJNx_h.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/upload": { "id": "routes/upload", "parentId": "root", "path": "/upload", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": false, "module": "/ai-resume-analyser/assets/upload-Bmlim26D.js", "imports": ["/ai-resume-analyser/assets/chunk-4WY6JWTD-Dcf9bGPO.js", "/ai-resume-analyser/assets/Navbar-BQbs2jcz.js", "/ai-resume-analyser/assets/utils-DXYMVh1-.js", "/ai-resume-analyser/assets/puter-CplJNx_h.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/resume": { "id": "routes/resume", "parentId": "root", "path": "/resume/:id", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": false, "module": "/ai-resume-analyser/assets/resume-BNxoSsy8.js", "imports": ["/ai-resume-analyser/assets/chunk-4WY6JWTD-Dcf9bGPO.js", "/ai-resume-analyser/assets/utils-DXYMVh1-.js", "/ai-resume-analyser/assets/puter-CplJNx_h.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/wipe": { "id": "routes/wipe", "parentId": "root", "path": "/wipe", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": false, "module": "/ai-resume-analyser/assets/wipe-DWESiodj.js", "imports": ["/ai-resume-analyser/assets/chunk-4WY6JWTD-Dcf9bGPO.js", "/ai-resume-analyser/assets/puter-CplJNx_h.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 } }, "url": "/ai-resume-analyser/assets/manifest-6b88a710.js", "version": "6b88a710", "sri": void 0 };
...
const publicPath = "/ai-resume-analyser/";
